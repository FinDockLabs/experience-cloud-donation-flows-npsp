...
2. Assign the **FinDock Experience Cloud Guest Access** permission set to your Experience Cloud site guest user. It grants access to the `Donation_Flow` flow and the `CurrencyPickerController` Apex class.
